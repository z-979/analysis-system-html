<template>
  <el-card shadow="always">
    <div slot="header" class="clearfix">
      <span style="float: left">app单日排行榜 :</span>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      //       "学习工具",
      //     ],
      //     datay: [123, 87, 60, 25, 18, 12],
      //   },
      // ];
      // let i = Math.round(Math.random() * 4);
      // let j = Math.round(Math.random() * 4);
      // this.datax = data1[i].datax;
      // this.datay = data1[j].datay;
